...
declare var $: any;
@Component({
    selector: 'motivo-devolucionvacacion-form',
    template: `
        ...
        <div class="modal-body">
                ...
                <div class="row">
                    <section class="col col-md-12">
                      <label class="control-label">Ingrese Motivo de Devolucion</label>
                      <label class="input"> 
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-lg bg-color-orange txt-color-white" (click)="onAccept($event)"> Devolver
            </button>
...
export class MotivoDevolucionVacacionComponent  {
