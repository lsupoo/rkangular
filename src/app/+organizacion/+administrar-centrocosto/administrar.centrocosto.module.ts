...
import {AdministrarCentroCostoComponent} from "./administrar.centrocosto.component";
...
@NgModule({
    ...
    declarations: [AdministrarCentroCostoComponent],
    providers: [
        CentroCostoService
    ],
    bootstrap: [AdministrarCentroCostoComponent]
})
export class AdministrarCentroCostoModule {
