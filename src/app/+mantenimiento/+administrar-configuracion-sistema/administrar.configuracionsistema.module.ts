...
import {
    AdministrarConfiguracionSistemaComponent
} from "./administrar.configuracionsistema.component";
...
@NgModule({
    ...
    declarations: [AdministrarConfiguracionSistemaComponent],
    providers: [
        ConfiguracionSistemaService
    ],
    bootstrap: [AdministrarConfiguracionSistemaComponent]
})
export class AdministrarConfiguracionSistemaModule {
